...
?>
<div class="ealain-product-view-wrapper">

	<?php
	if (is_shop() && $is_sidebar) { ?>
		<div class="ealain-filter-button shop-filter-sidebar">
			<i class="fas fa-filter"></i>
			<span class="ealain-btn-text"><?php esc_html_e("Filter", "ealain"); ?></span>
		</div>
	<?php
	}
	?>
	...
	<input id="skeleton_template_url" type="hidden" value="<?php echo get_template_directory_uri(); ?>" name="skeleton_template_url">
		<div class="ealain-product-view-buttons">
			<ul>
				<li>
					<a class="btn ealain-listing <?php echo esc_attr($is_view_listing) ?> ">
				...
				<li>
					<a class="btn ealain-view-grid <?php echo esc_attr($is_view_grid['3']) ?>" data-grid="2">
				...
				<li>
					<a class="btn ealain-view-grid <?php echo esc_attr($is_view_grid['4']) ?>" data-grid="3">
						<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<li>
					<a class="btn ealain-view-grid <?php echo esc_attr($is_view_grid['5']) ?>" data-grid="4">
						<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<form class="woocommerce-ordering" method="get">
		<select name="orderby" class="orderby" aria-label="<?php esc_attr_e('Shop order', 'ealain'); ?>">
