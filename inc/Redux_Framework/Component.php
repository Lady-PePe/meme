...
namespace Ealain\Ealain\Redux_Framework;
...
class Component implements Component_Interface
{
	...
	protected $opt_name = "ealain-options";
	/**
	...
	public function action_add_redux()
	{
		...
		$args = array(
			...
			'menu_title'           => esc_html__('Ealain Options', 'ealain'),
			'page_title'           => esc_html__('Ealain Options', 'ealain'),
			...
			'global_variable'      => 'ealain_options',
