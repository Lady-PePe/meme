...
if ( ! wc_ship_to_billing_address_only() && wc_shipping_enabled() ) {
	$get_addresses = apply_filters( 'woocommerce_my_account_get_addresses', array(
		'billing' => esc_html__( 'Billing address', 'ealain' ),
		'shipping' => esc_html__( 'Shipping address', 'ealain' ),
	), $customer_id );
} else {
	$get_addresses = apply_filters( 'woocommerce_my_account_get_addresses', array(
		'billing' => esc_html__( 'Billing address', 'ealain' ),
...
<p>
    <?php echo apply_filters( 'woocommerce_my_account_my_address_description', esc_html__( 'The following addresses will be used on the checkout page by default.', 'ealain' ) ); ?>
</p>
    ...
    <div class="row">
        ...
        <div class="u-column<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> col-lg-12 woocommerce-Address">
            <div class="woocommerce-Address-title title">
                <div class="ealain-address-section">
                    <h5><?php echo wp_kses_post($title); ?></h5>
                    <a class="ealain-button" href="<?php echo esc_url( wc_get_endpoint_url( 'edit-address', $name ) ); ?>"
                        class="edit ealain-button btn btn-hover">
                        <?php _e( 'Edit', 'ealain' ); ?>
                    </a>
                </div>
            </div>
            <address>  <?php
                ...
                <div class="table-responsive">
                    <table>
                        <tbody>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Name","ealain"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($name); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Company","ealain"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($company); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Country","ealain"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($country); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Address","ealain"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($address_2); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("E-mail","ealain"); ?></td>
                                <td class="seprator"><span>:</span></td>
                                <td><?php echo esc_html($user_email); ?></td>
                            </tr>
                            <tr>
                                <td class="label-name"><?php echo esc_html__("Phone","ealain"); ?></td>
                                <td class="seprator"><span>:</span></td>
